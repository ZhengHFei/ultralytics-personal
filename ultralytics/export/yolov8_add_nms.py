...
def main():
    ...
    parser.add_argument("-f", "--model", help="Path to the ONNX model generated by export_model.py", default="./model.onnx")
    ...
    name = os.path.basename(args.model[:-5])
    onnx.save(gs.export_onnx(graph), f"./onnx/{name}_nms.onnx")
